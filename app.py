...
with st.sidebar:
    ...
    api_key = st.text_input(
        ...
        type="password",
        placeholder="sk-...",
        help="Bring your own key to run embedding and generation requests. It is used only for this session.",
    )
    st.caption("No key? The README includes a complete video walkthrough.")
